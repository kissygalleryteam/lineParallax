...
kg/lineParallax/2.0.0/anim-helper
kg/lineParallax/2.0.0/index
 ...
 *              现方式，剔除不必要的功能，减少复杂度
 **/
KISSY.add('kg/lineParallax/2.0.0/anim-helper', function(S, Base, Node, anim) {
    var $ = Node.all;
...
KISSY.add('kg/lineParallax/2.0.0/index', function(S, Base, Node, anim, AnimHelper) {
    var $ = Node.all;
    /**
    ...
    S.extend(LineParallax, Base, /** @lends LineParallax.prototype*/ {
        ...
        _handleAction: function(action) {
            ...
            /*
             ...
             4、[0,100][402.0.000] (两个region) 如果在他们中间，计算的时候要考虑direction（方向）
             */
